    ...
    >
      <Box
        style={{
          ...
          height: "1px",
          background:
            "linear-gradient(90deg, transparent 0%, rgb(9,79,183) 50%, transparent 100%)",
        }}
      />
      <Box
        style={{
      ...
      >
        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="4rem" mb="4rem">
          ...
          >
            ...
            >
              <Box
                style={{
                  ...
                  borderRadius: "50%",
                  background:
                    "linear-gradient(135deg, rgb(9,79,183) 0%, rgb(41,106,205) 100%)",
                  display: "flex",
                  alignItems: "center",
            ...
            >
              As a back-end developer with a focus on{" "}
              <strong style={{ color: "rgba(255,255,255,0.8)" }}>
                Laravel
              </strong>
              , I have a deep understanding of web development principles and
              best practices. I have worked with front-end developers and
              designers to ensure seamless integration of front-end and back-end
              systems.
            </Text>
            <Text
              style={{
            ...
            >
              With experience spanning FinTech microservices, e-commerce
              platforms, educational systems and enterprise dashboards, I thrive
              on building solutions that are scalable, secure, and maintainable.
            </Text>
            ...
            <SimpleGrid cols={2} spacing="0.75rem">
              {[
                ...
                <Box key={item.label} className={classes.infoCard}>
                  ...
                  <Text
                    style={{
                      fontSize: item.small ? "0.72rem" : "0.82rem",
          ...
          >
            ...
            >
              <Box
                style={{
                  ...
                  height: "100%",
                  background:
                    "linear-gradient(180deg, rgb(9,79,183), rgb(100,170,255))",
                }}
              />
              <Group
                gap="1rem"
              ...
              >
                ...
                <Box>
                  ...
                  >
                    B.Sc. Electrical Engineering — Computer Engineering
                  </Title>
                  <Text
                    style={{
                      color: "rgb(9,79,183)",
                  ...
                  >
                    Faculty of Mechanical &amp; Electrical Engineering · GPA
                    74.69%
                  </Text>
                </Box>
              </Group>
            ...
            <Stack gap="0.6rem">
              {[
                {
                  icon: "🌍",
                  text: "Based in Syria — open to remote & relocation opportunities",
                },
                {
                  icon: "💼",
                  text: "Currently Senior Backend Developer at Ultra Wares",
                },
                {
                  icon: "🎯",
                  text: "Passionate about clean architecture, API design & Agile delivery",
                },
                {
                  icon: "📐",
                  text: "Experienced Scrum Master with JIRA project management",
                },
              ].map((f) => (
                <Group
                  key={f.icon}
