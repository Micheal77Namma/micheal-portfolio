...
const experiences = [
  {
    ...
    responsibilities: [
      ...
      "Utilized version control systems (e.g., Git) to manage code repositories, track changes, and collaborate with team members.",
      "Managed version control and CI/CD pipelines using Git, GitLab CI/CD, and other DevOps tools.",
    ],
    tags: [
      "Laravel",
      "PHP",
          ...
          {exp.current && (
            <Box
              style={{
                ...
                inset: "-5px",
                borderRadius: "50%",
                border: "1px solid rgba(9,79,183,0.4)",
      ...
      <Box style={{ flex: 1, marginBottom: "1.5rem" }}>
        ...
        >
          ...
          <Group
            ...
            align="flex-start"
            style={{ flexWrap: "wrap", gap: "0.75rem", paddingLeft: "0.5rem" }}
          >
            <Box>
          ...
          <Group
            gap="0.4rem"
            mt="1rem"
            style={{ paddingLeft: "0.5rem", flexWrap: "wrap" }}
          >
            {exp.tags.map((tag) => (
              <Badge
                key={tag}
                ...
                style={{
                  ...
                  border: "1px solid rgba(9,79,183,0.22)",
                }}
              >
                {tag}
              </Badge>
        ...
        <Box style={{ position: "relative" }}>
          <Box
            style={{
              ...
              width: "2px",
              background:
                "linear-gradient(180deg, rgb(9,79,183) 0%, rgba(9,79,183,0.08) 100%)",
            }}
          />
