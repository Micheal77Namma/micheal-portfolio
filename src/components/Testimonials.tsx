...
const testimonials = [
  {
    name: "Bisher AL Hasani",
    title: "Product Owner",
    tags: ["Product Management", "Agile / Scrum", "Sprint Planning"],
    linkedin: "https://www.linkedin.com/in/bisher-al-hasani-19008a219/",
    relationship: "Tradinous",
    text: `I had the opportunity to work alongside Michel Naameh for about a year and a half across two companies. Throughout this time, he proved to be a dependable backend developer with a strong ability to deliver results quickly and efficiently.

Michel consistently balances speed with quality, producing clean and maintainable code. He is also a supportive and cooperative team member who contributes positively to collaboration and problem-solving efforts.

I am confident he would be a strong addition to any backend team.`,
  },
  {
    name: "Nazem Almsouti",
    ...
    >
      ...
      <Box
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(9,79,183,0.05) 0%, transparent 70%)",
          pointerEvents: "none",
        }}
      />
                  ...
                  <Group gap="1rem" align="center">
                    ...
                    <Box
                      style={{
                        ...
                        borderRadius: "50%",
                        background:
                          "linear-gradient(135deg, rgb(9,79,183) 0%, rgb(60,130,220) 100%)",
                        display: "flex",
                        alignItems: "center",
