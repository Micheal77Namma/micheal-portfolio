  ...
  return (
    <Box
      ...
      style={{
        ...
        overflow: "hidden",
        background:
          "radial-gradient(ellipse 80% 60% at 60% 30%, rgba(9,79,183,0.10) 0%, transparent 70%), #07070b",
      }}
    >
      <canvas
        ref={canvasRef}
      ...
      <Box
        style={{
          ...
          pointerEvents: "none",
          backgroundImage:
            "linear-gradient(rgba(9,79,183,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(9,79,183,0.04) 1px, transparent 1px)",
      ...
      <Box
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(9,79,183,0.14) 0%, transparent 65%)",
          pointerEvents: "none",
        }}
      />
      <Box
        style={{
          ...
          borderRadius: "50%",
          background:
            "radial-gradient(circle, rgba(9,79,183,0.08) 0%, transparent 65%)",
          pointerEvents: "none",
        }}
      />
      ...
      >
        <Box style={{ maxWidth: "820px" }}>
            ...
            >
              ...
              >
                <Box
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg, rgb(9,79,183) 0%, rgb(100,170,255) 100%)",
                ...
                <Box
                  ...
                  style={{
                    ...
                    height: "3px",
                    background:
                      "linear-gradient(90deg, rgb(9,79,183), transparent)",
                    borderRadius: "2px",
                  }}
                />
              </Box>
          ...
          >
            <Text component="span" style={{ color: "rgba(255,255,255,0.35)" }}>
              &gt;_
            </Text>
            <Text component="span" style={{ color: "rgba(255,255,255,0.85)" }}>
              {displayed}
            </Text>
            <Box
              component="span"
              ...
              >
                <Box
                  style={{
                    ...
                    lineHeight: 1,
                    background:
                      "linear-gradient(135deg, #fff 0%, rgba(9,79,183,0.9) 100%)",
                    WebkitBackgroundClip: "text",
                    WebkitTextFillColor: "transparent",
                    marginBottom: "0.3rem",
                  }}
